...
public class DIFF_MATCH_PATCH {
	...
	/**
	 * Look for single edits surrounded on both sides by equalities which can be shifted sideways to align the edit to a word boundary. e.g: The
	 * c<ins>at c</ins>ame. -> The <ins>cat </ins>came.
	 * 
	 * @param diffs
	 *            LinkedList of Diff objects.
	 */
