...
/**
 * Class操作工具类。 提供与Class操作相关的方法。
 * 
 * @company jse-zq
 * @author dango
 * @since 1.0
 * @date 2015年3月22日 下午3:41:15
 */
public class ClassUtil {
	private static ZqLogger	logger	= new ZqLogger(ClassUtil.class);
	...
	public static Object getBeanFieldValue(Object obj, String fieldName) throws Exception {
		...
		if (field == null) {
			throw new ZqException("Can not find field : \"" + fieldName + "\" during "
	...
	public static void setFieldValue(Object obj, Field field, Object fieldValue) {
		...
		try {
			...
			logger.error("set field value error : " + obj.getClass().getSimpleName() + "." + field.getName());
			throw new ZqException(e);
		}
	}
